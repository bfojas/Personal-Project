...
class Profile extends Component {
  constructor(props) {
    super(props);
    this.state = { birds: "none", bankFont: "24px" };
  }
  ...
  render() {
    ...
    const data = {
      labels: ["Wins", "Losses", "Not Played"],
      datasets: [
        {
          data: chartPercent,
          backgroundColor: ["green", "#CC4400", "#CC4400"],
          hoverBackgroundColor: ["green", "#CC4400", "#CC4400"]
        }
      ]
    };
