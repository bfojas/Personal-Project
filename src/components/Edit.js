...
class Edit extends Component {
  ...
  colorToDb = color => {
    axios
      .put("/api/color", { color, auth0_id: this.props.auth0_id })
          ...
          <div className="colorContainer">
            ...
            <div className="colorBox">
              <div
                ...
                onClick={() => this.colorToDb("green")}
              />
              <div
                className="colorTwo"
                style={{ backgroundColor: "grey" }}
                onClick={() => this.colorToDb("grey")}
              />
              <div
                className="colorThree"
                style={{ backgroundColor: "#1A5387" }}
                onClick={() => this.colorToDb("#1A5387")}
              />
              <div
                className="colorFour"
                style={{ backgroundColor: "#871D0C" }}
                onClick={() => this.colorToDb("#871D0C")}
              />
            </div>
          </div>
        </div>
